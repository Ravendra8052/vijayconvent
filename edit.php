...
if (isset($_POST['submit']))
 {
    ...
    $query="UPDATE `faculty` SET `id`='$id',`name`='$name',`subject`='$subject',`qualification`='$qualification',`contact`='$contact' WHERE id=$id";
...
<div class="container">
  <h1 class="" align="center">Edit Teacher/Faculty</h1>
